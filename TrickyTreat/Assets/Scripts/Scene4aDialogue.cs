...
public void next(){
        ...
        if (primeInt == 1){
               ...
               ArtChar1b.SetActive(true);
                ...
                Char2speech.text = "Poor thing, an orphan all alone.";
        }
       else if (primeInt ==3){
                Char1name.text = "";
                Char1speech.text = "";
                Char2name.text = "GHOST";
                Char2speech.text = "You know it's been quite lonely haunting this place all on my lonesome, and I’ve been looking to adopt anyway.";
        }
       else if (primeInt == 4){
                Char1name.text = "YOU";
                Char1speech.text = "Yeah sure lady, now where's that better candy you talked about.";
                Char2name.text = "";
                Char2speech.text = "";
        }
       else if (primeInt == 5){
		   ...
		   ArtChar1a.SetActive(true);
                ...
                Char1speech.text = "";
                Char2name.text = "GHOST";
                Char2speech.text = "You will get it in due time, but first we must perform the ceremonial adoption ritual.";
        }
		  else if (primeInt == 6){
                Char1name.text = "YOU";
                Char1speech.text = "The what?";
                Char2name.text = "";
                Char2speech.text = "";
        }
				  else if (primeInt == 7){
                ...
                Char1speech.text = "";
                Char2name.text = "GHOST";
                Char2speech.text = "You know, the ceremonial adoption ritual, I'm offering to adopt you and give you a loving home.";
        }
			else if (primeInt == 8){
		   ArtChar1a.SetActive(false);
		   ArtChar1b.SetActive(true);
                ...
                Char1speech.text = "";
                Char2name.text = "GHOST";
                Char2speech.text = "It must be difficult being an orphan on the streets.";
        }
		...
		//response to choice 1a
		   ...
		   ArtChar1b.SetActive(false);
                ...
                Char1speech.text = "";
                Char2name.text = "GHOST";
                Char2speech.text = "Crazy? Is that the new kind of slang kids are using nowadays?";
        }
		       else if (primeInt == 21){
                Char1name.text = "";
                Char1speech.text = "";
                Char2name.text = "GHOST";
                Char2speech.text = "I can be crazy cool and radically slay!";
				primeInt = 39;
		}
		...
		//response to choice 1b
		   ...
		   ArtChar1b.SetActive(false);
             ...
             Char1speech.text = "";
             Char2name.text = "GHOST";
             Char2speech.text = "Yes of course, in due time.";
			primeInt = 39;
		}
...
// FUNCTIONS FOR BUTTONS TO ACCESS (Choice #1 and switch-scenes)
        public void Choice1aFunct(){
                Char1name.text = "YOU";
                Char1speech.text = "Your crazy lady!";
                Char2name.text = "";
                Char2speech.text = "";
                primeInt = 19;
                Choice1a.SetActive(false);
        ...
        public void Choice1bFunct(){
                Char1name.text = "YOU";
                Char1speech.text = "But do I get candy though?";
                Char2name.text = "";
                Char2speech.text = "";
                primeInt = 29;
                Choice1a.SetActive(false);
