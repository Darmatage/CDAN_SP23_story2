...
public void next(){
        ...
        if (primeInt == 1){
               ...
               ArtChar1a.SetActive(true);
                ...
                Char1name.text = "YOU";
                Char1speech.text = "Whoa I didn't even know this house was here.";
                Char2name.text = "";
                Char2speech.text = "";
        }
       else if (primeInt ==3){
		   ...
		   ArtChar1a.SetActive(false);
                Char1name.text = "";
                Char1speech.text = "";
                Char2name.text = "HOUSE";
                Char2speech.text = "I’ve always been here! You were just not prepared to see me yet. Until now.";
        }
       else if (primeInt == 4){
                Char1name.text = "YOU";
                Char1speech.text = "why tho?";
                Char2name.text = "";
                Char2speech.text = "";
        }
       else if (primeInt == 5){
                ...
                Char1speech.text = "";
                Char2name.text = "HOUSE";
                Char2speech.text = " I've been waiting for the most tenacious and amazing trick or treater to ever step foot on this street.";
        }
		  else if (primeInt == 6){
                Char1name.text = "YOU";
                ...
                Char1speech.text = "";
                Char2name.text = "HOUSE";
                Char2speech.text = "Because it is my duty, and life's work to present this hero with-";
        }
			else if (primeInt == 8){
		   ArtChar1a.SetActive(false);
		   ArtChar1b.SetActive(true);
		   ...
		   ArtChar1b.SetActive(true);
                ...
                Char1speech.text = "";
                Char2name.text = "HOUSE";
                Char2speech.text = "Child please! Let me speak!";
        }
		else if (primeInt == 10){
                Char1name.text = "YOU";
                Char1speech.text = "";
		...
		//response to choice 1a
		  ...
		  ArtChar1a.SetActive(true);
		   ArtChar1b.SetActive(false);
                ...
                Char1name.text = "YOU";
                Char1speech.text = "hello? Mr.House are you still there?";
                Char2name.text = "";
                Char2speech.text = "";
		   ...
		   ArtChar1c.SetActive(true);
                ...
                Char1speech.text = "";
                Char2name.text = "HOUSE";
                Char2speech.text = " Ugh just take your prize and leave me alone.";
				primeInt = 39;
		}
